...
def render_with_depth(viewpoint_camera, pc : GaussianModel, pipe, bg_color : torch.Tensor, scaling_modifier = 1.0, override_color = None, opt: OptimizationParams = None, 
           is_training=False, dict_params=None, depth = True):
    """
    ...
    rasterizer_depth = GaussianRasterizer_depth(raster_settings=raster_settings)
    ...
    if depth==True:
        _,_, depth_map, weight_map = rasterizer_depth(
        means3D = means3D, 
        means2D = means2D,  
        shs = shs,          
        colors_precomp = colors_precomp,
        ...
        rotations = rotations,  
        cov3D_precomp = cov3D_precomp)
        # print(depth_map.shape, weight_map.shape)
        # input()
        # print(depth_map)
        # print(weight_map)
        # print(rendered_image)
        # input()
        depth_map_real = depth_map
        depth_map = (1-depth_map_real/24).clamp(0,1)
        # print(depth_map)
        # print(depth_map.min(), depth_map.max())
        # input()
        # depth_map/=depth_map.mean()
        # print(depth_map_real.max())
