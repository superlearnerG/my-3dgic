...
import numpy as np
from utils.graphics_utils import getWorld2View2, getProjectionMatrix, getProjectionMatrixCenterShift, getC2W
...
class Camera(nn.Module):
    def __init__(self, colmap_id, R, T, FoVx, FoVy, fx, fy, cx, cy, image, objects, image_name, uid,
        ...
        self.camera_back_project = torch.tensor(getC2W(R, T, trans, scale)).cuda()
